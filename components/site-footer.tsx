export function SiteFooter() {
  return (
    <footer
      id="contact"
      className="scroll-mt-16 bg-neutral-100 px-6 py-16 sm:px-10 sm:py-24 lg:px-14"
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-12 sm:flex-row sm:items-end sm:justify-between">
        <div className="font-mono text-xs font-light leading-[1.5] text-black sm:text-sm">
